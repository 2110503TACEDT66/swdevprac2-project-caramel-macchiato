  ...
  return (
    <div className="relative hover:-translate-y-1 duration-150 cursor-pointer">
      {/* <Image
        ...
        alt=""
      /> */}
      <div className="bg-gray-200 w-full h-80 rounded-3xl"></div>
      <div className="flex text-sm items-center gap-2 absolute top-5 right-5 bg-white px-3 py-1 rounded-full text-green-700">
